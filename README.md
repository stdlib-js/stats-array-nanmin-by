...
```javascript
import nanminBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-nanmin-by@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-array-nanmin-by/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-array-nanmin-by/actions/workflows/test.yml?query=branch:v0.1.1
